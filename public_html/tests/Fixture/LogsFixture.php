...
class LogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'log_start_time' => ['type' => 'time', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'log_end_time' => ['type' => 'time', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'log_time_diff_min' => ['type' => 'string', 'length' => 6, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'log_date' => '2018-08-27',
                'log_start_time' => '17:34:48',
                'log_end_time' => '17:34:48',
                'log_time_diff_min' => 'Lore'
            ],
        ];
        parent::init();
    }
