...
class ProjectsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'project_start_date' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'project_end_date' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'project_start_date' => '2018-08-29',
                'project_end_date' => '2018-08-29'
            ],
        ];
        parent::init();
    }
