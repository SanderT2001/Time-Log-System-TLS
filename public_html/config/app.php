...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '10b0434f81e9c1dae6bca258183f82a40bce153f28fba1a7a93e0e3a79fef7cc'),
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'password' => env('DATABASE_PASSOWORD', ''),
            'database' => env('DATABASE_NAME', 'time_log_system_tls'),
            /*
